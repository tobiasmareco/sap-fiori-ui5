		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices App",
									"targetURL": "#invoicesapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicesapui5-display": {
								"semanticObject": "invoicesapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoice.sapui5",
									"url": sap.ui.require.toUrl("invoice/sapui5")
								}
							}
						}
					}
